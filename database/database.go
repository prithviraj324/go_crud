...
import (
	...
	"github.com/prithviraj324/go_crud/graph/model"
...
var connectionString string = "mongodb+srv://prithviraj324:mongodb@user-details.btynhqw.mongodb.net/test"
...
func (db *DB) GetJob(id string) *model.JobListing {
	jobCollec := db.client.Database("joblistdb").Collection("jobs")
	ctx, cancel := context.WithTimeout(context.Background(), 30*time.Second)
	defer cancel()
